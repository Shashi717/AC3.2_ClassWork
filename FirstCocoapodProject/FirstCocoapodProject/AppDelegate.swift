//
//  AppDelegate.swift
//  FirstCocoapodProject
//
//  Created by Madushani Lekam Wasam Liyanage on 11/29/16.
...
//        
//        //put request
//        Alamofire.request("https://jsonplaceholder.typicode.com/posts", method: .post, Parameters: nil).validate().responseJSON { (response) in
//            
//            if let json = response.result.value {
//                print("JSON: \(json)")
//            }
